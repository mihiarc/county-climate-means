#!/usr/bin/env python3
"""
Multiprocessing Climate Data Processing

High-performance multiprocessing implementation for climate data processing.
Designed to work with existing climate_means.py functions while utilizing
...
def main():
    """Main function for testing multiprocessing climate processing."""
    ...
    benchmark_multiprocessing_speedup(data_directory, num_files=6)
    
    # Process a small historical period
    logger.info("Processing historical precipitation (2012-2014) with multiprocessing...")
    result_path = processor.process_historical_precipitation_parallel(2012, 2014)
    logger.info(f"Historical processing complete: {result_path}")
